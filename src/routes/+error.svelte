...
<!-- <h1>
    404 error 😭 can't find <strong
        >{browser && window.location.pathname}</strong
    >
</h1> -->
<div class="container">
    <h1>
        <span class="four">4</span>
        <span class="oh">0</span>
        <span class="for">4</span>
    </h1>
    <div class="the-message">
        <img
            src="https://assets.make-bookmarklets.com/goathead.svg"
            role="presentation"
            alt="Goat Head"
            class="the-goat"
        />
